...
"""
Prowlarr plugin utility classes and functions.
"""
...
def zulu_datetime_format(dt: datetime) -> str:
    """
    Convert a naive or timezone-aware `datetime` object to a ISO-8601 string
